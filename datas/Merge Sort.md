...
The space complexity of merge sort is O(n) due to the auxiliary space used for merging.

## Use Cases

Merge sort is useful for sorting linked lists, external sorting (sorting large amounts of data that do not fit into memory), and for applications where stable sorting is required.
